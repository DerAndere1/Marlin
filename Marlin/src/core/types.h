...
struct XYZval {
  ...
  #endif
  #if LINEAR_AXES >= 8
    FI void set(const T px, const T py, const T pz, const T pi, const T pj, const T pk, const T pm) { x = px; y = py; z = pz; i = pi; j = pj; k = pk; u = pm; }
  #endif
  #if LINEAR_AXES >= 9
    FI void set(const T px, const T py, const T pz, const T pi, const T pj, const T pk, const T pm, const T po) { x = px; y = py; z = pz; i = pi; j = pj; k = pk; u = pm; v = po; }
  #endif
