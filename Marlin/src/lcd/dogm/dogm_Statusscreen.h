...
#endif
#if (HOTENDS > 0) && (!ALL(LCD_SHOW_SECONDARY_AXES, HAS_K_AXIS))
...
#endif
#if ALL(HAS_HOTEND, STATUS_HOTEND_ANIM) && DISABLED(LCD_SHOW_SECONDARY_AXES)
  #define ANIM_HOTEND 1
#endif
#if ALL(DO_DRAW_BED, STATUS_BED_ANIM) && DISABLED(LCD_SHOW_SECONDARY_AXES)
  #define ANIM_BED 1
#endif
#if ALL(DO_DRAW_CHAMBER, STATUS_CHAMBER_ANIM) && DISABLED(LCD_SHOW_SECONDARY_AXES)
  #define ANIM_CHAMBER 1
#endif
#if ALL(DO_DRAW_CUTTER, STATUS_CUTTER_ANIM) && DISABLED(LCD_SHOW_SECONDARY_AXES)
  #define ANIM_CUTTER 1
#endif
#if ALL(DO_DRAW_COOLER, STATUS_COOLER_ANIM) && DISABLED(LCD_SHOW_SECONDARY_AXES)
  #define ANIM_COOLER 1
#endif
#if ALL(DO_DRAW_FLOWMETER, STATUS_FLOWMETER_ANIM) && DISABLED(LCD_SHOW_SECONDARY_AXES)
