    ...
    #if ENABLED(TOOLCHANGE_PARK)
    {
      ...
      SERIAL_ECHOPGM_P(
          ...
          , LIST_N(DOUBLE(SECONDARY_AXES), 
              PSTR(" I"), IF_DISABLED(AXIS4_ROTATES, LINEAR_UNIT)(toolchange_settings.change_point.i),
              PSTR(" J"), IF_DISABLED(AXIS5_ROTATES, LINEAR_UNIT)(toolchange_settings.change_point.j),
              PSTR(" K"), IF_DISABLED(AXIS6_ROTATES, LINEAR_UNIT)(toolchange_settings.change_point.k),
