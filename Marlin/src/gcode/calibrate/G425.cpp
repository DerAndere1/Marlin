...
#endif
#if HAS_U_AXIS && BOTH(CALIBRATION_MEASURE_UMIN, CALIBRATION_MEASURE_UMAX)
  #define HAS_U_CENTER 1
#endif
#if HAS_V_AXIS && BOTH(CALIBRATION_MEASURE_VMIN, CALIBRATION_MEASURE_VMAX)
  #define HAS_V_CENTER 1
#endif
#if HAS_W_AXIS && BOTH(CALIBRATION_MEASURE_WMIN, CALIBRATION_MEASURE_WMAX)
